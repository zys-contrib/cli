...
class FetcherBase {
  ...
  set integrity (i) {
    ...
    i = ssri.parse(i)
    const current = ssri.parse(this.opts.integrity)
  ...
  pickIntegrityAlgorithm () {
    return this.integrity
      ? ssri.parse(this.integrity).pickAlgorithm(this.opts)
  ...
  [_annotate] (manifest) {
    const annotated = {
      _from: this.spec.saveSpec || this.spec.raw,
      _requested: this.spec,
      _spec: this.spec.raw,
      _where: this.opts.where
    }
    const decorated = {
    ...
    this.package = (this.opts.annotate)
      ? {
          ...manifest,
          ...annotated,
          ...decorated
